...
public class ChestItem : MonoBehaviour
{
    ...
    private IEnumerator MaterializeItem(Color materializeColor, string text)
    {
        ...
        yield return StartCoroutine(materializeEffect.MaterializeRoutine(GameResources.Instance.shader_Materialize, materializeColor, 1f, spriteRendererArray, GameResources.Instance.material_lit));
