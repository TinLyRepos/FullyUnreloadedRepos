...
public class Chest : MonoBehaviour, IUseable
{
    ...
    private IEnumerator MaterializeChest()
    {
        ...
        yield return StartCoroutine(materializeEffect.MaterializeRoutine(GameResources.Instance.shader_Materialize, materializeColor, materializeTime, spriteRendererArray, GameResources.Instance.material_lit));
